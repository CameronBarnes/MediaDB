...
public class HelpForm {
    ...
    public HelpForm() {
        ...
        String acceptableTagTypesWOrAndPeriod = Utils.convertArrayToGrammaticallyAcceptableList(Tag.TagType.values(), false, true);
        ...
        mMainText.setText(String.format("""
                ...
                """, Utils.convertArrayToGrammaticallyAcceptableList(ContentType.values(), false, true), acceptableTagTypesWOrAndPeriod));
